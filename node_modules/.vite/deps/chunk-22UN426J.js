...
var r = function() {
  return r = Object.assign || function(t2) {
    for (var n2, r3 = 1, e = arguments.length; r3 < e; r3++)
      for (var o4 in n2 = arguments[r3])
        Object.prototype.hasOwnProperty.call(n2, o4) && (t2[o4] = n2[o4]);
    return t2;
...
function o(t2, n2, r3, e) {
  return new (r3 || (r3 = Promise))(function(o4, a2) {
    ...
    function i2(t3) {
      var n3;
      t3.done ? o4(t3.value) : (n3 = t3.value, n3 instanceof r3 ? n3 : new r3(function(t4) {
        t4(n3);
      })).then(c2, l);
    }
          ...
          try {
            ...
            switch (e = 0, o4 && (a4 = [2 & a4[0], o4.value]), a4[0]) {
              ...
              case 7:
                ...
                continue;
              default:
                if (!(o4 = c2.trys, (o4 = o4.length > 0 && o4[o4.length - 1]) || 6 !== a4[0] && 2 !== a4[0])) {
                  c2 = 0;
                  continue;
                }
                if (3 === a4[0] && (!o4 || a4[1] > o4[0] && a4[1] < o4[3])) {
                  c2.label = a4[1];
                  break;
                }
                if (6 === a4[0] && c2.label < o4[1]) {
                  c2.label = o4[1], o4 = a4;
                  break;
                }
                if (o4 && c2.label < o4[2]) {
...
function o2(n2, t2) {
  void 0 === t2 && (t2 = false);
  var e = window.crypto.getRandomValues(new Uint32Array(1))[0], o4 = "_".concat(e);
  return Object.defineProperty(window, o4, { value: function(e2) {
    return t2 && Reflect.deleteProperty(window, o4), null == n2 ? void 0 : n2(e2);
...
//# sourceMappingURL=chunk-22UN426J.js.map
